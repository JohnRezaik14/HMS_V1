...
INSERT INTO `clinicss_skd` VALUES (1,'14:30:00','15:00:00',1,1,1,NULL);
...
INSERT INTO `doctor` VALUES (1,'26610020604062',NULL,'Ali','Farag',NULL,NULL,NULL,NULL,3,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `patient` VALUES (21,10,'30012090201054','John Lamei Shahin Rezaik','John','Lamei','Shahin','Rezaik','2000-12-08',22,1,0,0,53,0,'Egypt, Alexandria, , 211, 6, 1','Egypt','Alexandria','','211','6',1,NULL,'',NULL,'','01029182175',0.00,0.00,'','  ','','','','','2023-04-28 09:06:39','2023-05-11 20:50:59',NULL,NULL),(22,11,'30012090661122','Ahmed Fathy Hagag Abdallah','Ahmed','Fathy','Hagag','Abdallah','2000-05-08',23,0,0,0,53,1,'Egypt, Cairo, , 64, 8, 6','Egypt','Cairo','','64','8',6,NULL,'',NULL,'','01029182698',0.00,0.00,'','Egypt, Alexandria, ','Egypt','Alexandria','','','2023-04-28 13:02:00','2023-05-11 21:03:38',NULL,NULL),(23,9,'30012090661121','Badieh Nader Naeim El masry','Badieh','Nader','Naeim','El masry','2000-10-09',22,1,0,0,53,2,'Egypt, Alexandria, keliopatra, 11, 4, 3','Egypt','Alexandria','keliopatra','11','4',3,NULL,'Egypt',NULL,NULL,'01029182633',NULL,NULL,'Dev','Germany, Berlin, City','Germany','Berlin','City',NULL,'2023-05-11 12:18:12','2023-05-11 21:05:58',NULL,NULL);
...
CREATE TABLE `patient_appt` (
  ...
  CONSTRAINT `Patient_Appt_Clinicss_Skd` FOREIGN KEY (`clinicssSkdId`) REFERENCES `clinicss_skd` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `patient_appt` VALUES (6,'2023-10-12','14:20:00','14:55:00','report','canceled',21,1,NULL,'2023-05-11 19:57:15','2023-05-11 20:36:22'),(7,'2023-10-09','14:35:00','14:51:00','report','completed',21,1,NULL,'2023-05-11 20:30:13','2023-05-11 20:30:13');
...
-- Dump completed on 2023-05-11 23:19:24
