...
INSERT INTO `doctor` VALUES (1,'26610020604062',NULL,'Ali','Farag',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `er_adm_and_dc` (
  ...
  CONSTRAINT `Adm_Disc_Pat` FOREIGN KEY (`Patient_Id`) REFERENCES `patient` (`Patient_Id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `icu_adm_dc` (
  ...
  CONSTRAINT `ICU_Adm_Disc_Pat` FOREIGN KEY (`Patient_Id`) REFERENCES `patient` (`Patient_Id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `old_history` (
  ...
  CONSTRAINT `Old_History_Pat` FOREIGN KEY (`Patient_Id`) REFERENCES `patient` (`Patient_Id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `patient` (
  ...
  UNIQUE KEY `National_Id_Card_UNIQUE` (`National_Id`),
  UNIQUE KEY `User_Id_UNIQUE` (`User_Id`),
  KEY `max_Patient_id_idx` (`Patient_Id` DESC),
  CONSTRAINT `User_Patient` FOREIGN KEY (`User_Id`) REFERENCES `user` (`userId`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `patient` VALUES (21,10,'30012090201054','John Lamei Shahin Rezaik','John','Lamei','Shahin','Rezaik','2000-12-08',0,0,0,0,53,0,'    ','','','','','','','','01029182175',0.00,0.00,'','','','','','','','2023-04-28 09:06:39','2023-04-29 08:32:17'),(22,11,'30012090661122','Ahmed Fathy Hagag Abdallah','Ahmed','Fathy','Hagag','Abdallah','2000-05-08',0,0,0,0,53,0,'    ','','','','','','','','01029182698',0.00,0.00,'','','','','','','','2023-04-28 13:02:00','2023-04-29 08:32:17');
...
CREATE TABLE `patient_appt` (
  ...
  CONSTRAINT `Patient_Appt_Patient` FOREIGN KEY (`Patient_Id`) REFERENCES `patient` (`Patient_Id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-05-10 13:04:32
