...
CREATE TABLE `patient` (
  ...
  `jobAddress` varchar(150) DEFAULT NULL COMMENT 'Composite attribute',
  `jobCountry` varchar(50) DEFAULT NULL,
...
INSERT INTO `patient` VALUES (21,10,'30012090201054','John Lamei Shahin Rezaik','John','Lamei','Shahin','Rezaik','2000-12-08',22,1,0,0,53,0,NULL,'Egypt','Alexandria','','','',NULL,NULL,'',NULL,'','01029182175',0.00,0.00,'','  ','','','','','2023-04-28 09:06:39','2023-05-11 12:18:12',NULL,NULL),(22,11,'30012090661122','Ahmed Fathy Hagag Abdallah','Ahmed','Fathy','Hagag','Abdallah','2000-05-08',23,0,0,0,53,1,NULL,'Egypt','Cairo','','','',NULL,NULL,'',NULL,'','01029182698',0.00,0.00,'','  ','','','','','2023-04-28 13:02:00','2023-05-11 17:45:39',NULL,NULL),(23,9,'30012090661121','Badieh Nader Naeim El masry','Badieh','Nader','Naeim','El masry','2000-10-09',22,1,0,0,53,2,NULL,'Egypt','Alexandria','keliopatra',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'01029182633',NULL,NULL,'Dev',NULL,'Germany','Berlin',NULL,NULL,'2023-05-11 12:18:12','2023-05-11 17:52:27',NULL,NULL);
...
CREATE TABLE `patient_appt` (
  ...
  `apptState` enum('upcoming','canceled','completed') DEFAULT NULL,
...
-- Dump completed on 2023-05-11 20:16:28
